...
/**
 * Created by Chen Jinglin on 2019/6/11.
 */
public class POP3Client {
    ...
    public static void main(String[] args) throws UnknownHostException, IOException {
        ...
        String user="15827121146@163.com";//用户名，填写自己的邮箱用户名
        String password="cjl19980516.";//密码，填写自己的密码
    ...
    //删除
    public void dele(int mailNum,BufferedReader in,BufferedWriter out)throws IOException, InterruptedException{
        String result = null;
        ...
        if(!"+OK".equals(result)){
            ...
            throw new IOException("删除邮件出错!");
        }

        System.out.println("删除第"+mailNum+"封");
    }
